                ...
                <div class="card shadow-lg ">
                    <div class="card-body ">
                        <div class=" padding-box-2 ">
                            ...
                            <?php } ?>
                            <form method="POST" action="<?php echo base_url() ?>auth/proceedResetRequest">
                                <fieldset <?php if($is_valid == false) { echo "disabled"; } ?>>
                                    <div class="form-group">
                                        <label>Verification Code</label>
                                        <div class="input-group input-group-flush mb-3">
                                            <input type="text" class="form-control form-control-prepended" placeholder="" name='code' required>
                                        ...
                                        <div class="input-group input-group-flush mb-3">
                                            <input type="password" class="form-control form-control-prepended" placeholder="" name='password' required>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <span class=" mdi mdi-lock"></span>
                                                </div>
                                        ...
                                        <div class="input-group input-group-flush mb-3">
                                            <input type="password" class="form-control form-control-prepended" placeholder="" name='password2' required>
