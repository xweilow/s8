...
<main class="admin-main  ">
    <div class="container-fluid">
        <div class="row ">
                        ...
                        <form class="needs-validation" action="#">
                            <div class="form-row">
                                <div class="form-group floating-label col-md-12">
                                    ...
                                    <input type="text" required class="form-control" placeholder="Username" autocomplete="new-password">
                                </div>
                                <div class="form-group floating-label col-md-12">
                                    <label>Password</label>
                                    <input type="password" required class="form-control " placeholder="Password" autocomplete="new-password">
                                </div>
                            </div>
            ...
            <div class="col-lg-8 d-none d-md-block bg-cover" style="background-image: url('<?= base_url() ?>assets/img/login.svg');">
