                ...
                <div class="col-md-6 text-white p-b-30">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h1>Wallet Report</h1>
                            <p class="opacity-75">Report For Member's Wallet Transaction.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="list-group list  list-group-flush">
                        ...
                        <div class="list-group-item d-flex  align-items-center">
                            <div class="m-r-20">
                                <div class="avatar avatar-sm">
                                    <div class="avatar-title rounded-circle bg-warning">W</div>
                                </div>
                            </div>
                            <div class="">
                                <div class="name"><?php echo isset($member) ? number_format($member['cash_wallet'], 2) : '-' ?></div>
