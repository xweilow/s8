...
<script>
    ...
    $('#form-registration').submit(function() {
        if($('#sponsor_id').val() == '' || $('#account_name').val() == '' || $('#password').val() == '' || $('#sec_password').val() == '' || $('#fname').val() == '' || $('#email').val() == '' || $('#mobile').val() == '' || $('#ic').val() == '') {
        ...
        var formData = new FormData();
        formData.append("sponsor_id", $('#sponsor_id').val().toLowerCase());
