                ...
                <div class="col-md-6 text-white p-b-30">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h1>Rejected Withdrawal</h1>
                            <p class="opacity-75">Withdrawal Transactions That Have Been Rejected By The Company.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table id="example"class="table" style="width:100%">
                                <thead>
                                    <tr style="text-align: center;">
                                        ...
                                        <th style="min-width: 200px;">Rejection Details</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr style="text-align: center;">
                                        ...
                                        <td>
                                            <?php echo $record['rejected_at'] ?><br />
