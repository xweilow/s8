                ...
                <div class="card shadow-lg ">
                    <div class="card-body ">
                        <div class=" padding-box-2 ">
                            ...
                            <?php } ?>
                            <form method="POST" action="<?php echo base_url() ?>auth/createResetRequest">
                                <div class="form-group">
                                    <label>Email</label>

                                    <div class="input-group input-group-flush mb-3">
                                        <input type="email" class="form-control form-control-prepended" placeholder="yourmail@example.com" name='email' required>
